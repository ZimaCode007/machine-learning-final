...
Usage:
    .venv/Scripts/python.exe Models/T5/train_local.py
"""
import sys
import os
import json
...
project_root = proj_dir.parent.parent
...
class ChartQADataset(Dataset):
    def __init__(self, data_dir, tokenizer, max_input_len=512, max_output_len=64):
        ...
        csv_path = os.path.join(data_dir, "data_with_tables.csv")
...
def train():
    ...
    output_dir = proj_dir / "saved_model"
    backbone = "t5-base"
    epochs = 5
    batch_size = 8
    valid_batch_size = 4
    ...
    valid_ds = ChartQADataset(str(data_dir / "validation"), tokenizer, max_input_len, max_output_len)
    ...
    valid_evaluator = Evaluator(str(data_dir / "validation"))
