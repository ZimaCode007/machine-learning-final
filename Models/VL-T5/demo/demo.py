...
vlt5_dir = os.path.dirname(script_dir)
project_dir = os.path.dirname(os.path.dirname(vlt5_dir))
sys.path.insert(0, os.path.join(vlt5_dir, "src"))
...
def main():
    ...
    print(f"\n{'='*60}")
    print(f"  ACCURACY RESULTS (VL-T5)")
    print(f"{'='*60}")
